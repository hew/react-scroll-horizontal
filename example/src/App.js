    ...
    return (
      <main>
        <div className="center w50 mx-auto mb">
          ...
          <h3>
            Feed &lt;ScrollHorizontal&gt; one child, or many children. So long as they have a
            defined width/height, this component will take care of the rest.
          </h3>
        ...
        <div className="hr" />
        <h1 className="center" onClick={e => this.setState({ someDivs: this.genData() })}>
          Full Width
        </h1>
